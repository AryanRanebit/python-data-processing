...
if __name__ == "__main__":
    ...
    # Create batch 1 sample input
    batch1_data = {
        "id": [1, 2, 3, 4],
        "customer_name": ["Alice", "Bob", "CorruptedUser", "Diana"],
        "account_balance": [1500.50, -50.00, 2300.00, 500.00],  # Bob has negative balance
        "credit_score": [750, 680, 200, 810],                   # CorruptedUser has score 200 (< 300)
    ...
    # Create batch 2 sample input (incremental update)
    batch2_data = {
        "id": [5, 6],
